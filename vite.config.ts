...
const manualChunks = (id: string) => {
  ...
  if (modulePath.startsWith("wouter/")) return "vendor-routing";
  if (modulePath.startsWith("@tanstack/react-query/")) return "vendor-query";
  if (modulePath.startsWith("@radix-ui/")) return "vendor-radix";
  if (
  ...
  if (modulePath.startsWith("framer-motion/")) return "vendor-motion";
  if (modulePath.startsWith("lucide-react/") || modulePath.startsWith("react-icons/")) return "vendor-icons";
  if (
